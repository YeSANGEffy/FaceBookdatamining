...
[bestmse,bestc,bestg] = svmregress(trainlabel,traindata,-5,5,-5,5,3,1,1,0.0005);
...
[bestmse,bestc,bestg] = svmregress(trainlabel,traindata,0,5,-5,0,3,0.3,0.3,0.0002);
...
fprintf('Predict the sf4 of the training data and compare to the grand truth.\n');
pause;


%Do training by using svmtrain of libsvm
cmd = ['-c ', num2str(bestc), ' -g ', num2str(bestg) , ' -s 3 -p 0.01 -h 0'];
